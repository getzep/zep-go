...
package graph_observation_test
...
func TestGraphObservationListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Graph.Observation.List(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestGraphObservationListWithWireMock"}},
		),
	)
...
func TestGraphObservationGetWithWireMock(
	...
	_, invocationErr := client.Graph.Observation.Get(
		context.TODO(),
		"graph_uuid",
		"observation_uuid",
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestGraphObservationGetWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestGraphObservationGetWithWireMock", "GET", "/graphs/graph_uuid/observations/observation_uuid", nil, 1)
}

...
func TestSettersDocumentSummaryListRequest(t *testing.T) {
	t.Run("SetLimit", func(t *testing.T) {
		obj := &DocumentSummaryListRequest{}
...
func TestSettersMarkExplicitDocumentSummaryListRequest(t *testing.T) {

...
func TestLookupBatchWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Lookup.Batch(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestLookupBatchWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestLookupBatchWithWireMock", "POST", "/lookup", nil, 1)
}

...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/getzep/zep-go/v2")
	headers.Set("X-Fern-SDK-Version", "v2.0.0-rc.5")
	headers.Set("User-Agent", "github.com/getzep/zep-go/2.0.0-rc.5")
	return headers
}

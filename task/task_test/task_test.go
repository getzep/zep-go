...
func TestTaskListWithWireMock(
	...
	_, invocationErr := client.Task.List(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestTaskListWithWireMock"}},
		),
	)
...
func TestTaskGetWithWireMock(
	...
	_, invocationErr := client.Task.Get(
		context.TODO(),
		"task_uuid",
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestTaskGetWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestTaskGetWithWireMock", "GET", "/tasks/task_uuid", nil, 1)
}
